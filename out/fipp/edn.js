...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__2699,open,xs,sep,close,f){
...
var printer = map__2700__$1;
var print_level = cljs.core.get.call(null,map__2700__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__2700__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__2702 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.call(null,G__2702,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__2702;
}
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,(function (p1__2698_SHARP_){
return f.call(null,printer__$1,p1__2698_SHARP_);
})),cljs.core.interpose.call(null,sep));
var ys = ((((function (){var or__4185__auto__ = print_level;
...
var ellipsis = (cljs.core.truth_((function (){var and__4174__auto__ = print_length;
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k2704,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k2704,else__4442__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4461__auto__,p__2709){
var vec__2710 = p__2709;
var k__4462__auto__ = cljs.core.nth.call(null,vec__2710,(0),null);
var v__4463__auto__ = cljs.core.nth.call(null,vec__2710,(1),null);
...
return cljs.core.pr_sequential_writer.call(null,writer__4454__auto__,pr_pair__4456__auto__,"#fipp.edn.EdnPrinter{",", ","}",opts__4455__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"symbols","symbols",1211743),self__.symbols],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),self__.print_meta],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"print-length","print-length",1931866356),self__.print_length],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"print-level","print-level",-1825423733),self__.print_level],null))], null),self__.__extmap));
}));

(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__2703){
var self__ = this;
var G__2703__$1 = this;
return (new cljs.core.RecordIter((0),G__2703__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__2713){
var self__ = this;
var map__2714 = p__2713;
var map__2714__$1 = (((((!((map__2714 == null))))?(((((map__2714.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2714.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2714):map__2714);
var tag = cljs.core.get.call(null,map__2714__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__2714__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"group","group",582596132),"#",cljs.core.pr_str.call(null,tag),(cljs.core.truth_((function (){var or__4185__auto__ = (function (){var and__4174__auto__ = self__.print_meta;
if(cljs.core.truth_(and__4174__auto__)){
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll.call(null,this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__2716){
var vec__2717 = p__2716;
var k = cljs.core.nth.call(null,vec__2717,(0),null);
var v = cljs.core.nth.call(null,vec__2717,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this2705,other2706){
var self__ = this;
var this2705__$1 = this;
return (((!((other2706 == null)))) && ((this2705__$1.constructor === other2706.constructor)) && (cljs.core._EQ_.call(null,this2705__$1.symbols,other2706.symbols)) && (cljs.core._EQ_.call(null,this2705__$1.print_meta,other2706.print_meta)) && (cljs.core._EQ_.call(null,this2705__$1.print_length,other2706.print_length)) && (cljs.core._EQ_.call(null,this2705__$1.print_level,other2706.print_level)) && (cljs.core._EQ_.call(null,this2705__$1.__extmap,other2706.__extmap)));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__2703){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__2720 = cljs.core.keyword_identical_QMARK_;
var expr__2721 = k__4447__auto__;
if(cljs.core.truth_(pred__2720.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__2721))){
return (new fipp.edn.EdnPrinter(G__2703,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2720.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__2721))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__2703,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2720.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__2721))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__2703,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2720.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__2721))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__2703,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4447__auto__,G__2703),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__2703){
var self__ = this;
var this__4438__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__2703,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__2707){
var extmap__4478__auto__ = (function (){var G__2723 = cljs.core.dissoc.call(null,G__2707,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
if(cljs.core.record_QMARK_.call(null,G__2707)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__2723);
} else {
return G__2723;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__2707),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__2707),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__2707),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__2707),null,cljs.core.not_empty.call(null,extmap__4478__auto__),null));
});

fipp.edn.pprint = (function fipp$edn$pprint(var_args){
var G__2726 = arguments.length;
switch (G__2726) {
case 1:
...
var _STAR_print_meta_STAR__orig_val__2727 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__2728 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__2728);

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__2727);
}}));
