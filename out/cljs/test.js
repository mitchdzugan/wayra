...
var G__2548 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__2548,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__2548;
}
}));
...
var len__4789__auto___2553 = arguments.length;
var i__4790__auto___2554 = (0);
while(true){
if((i__4790__auto___2554 < len__4789__auto___2553)){
args__4795__auto__.push((arguments[i__4790__auto___2554]));

var G__2555 = (i__4790__auto___2554 + (1));
i__4790__auto___2554 = G__2555;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq2550){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2551,G__2552,seq2550__$2);
}));
...
var map__2557 = m;
var map__2557__$1 = (((((!((map__2557 == null))))?(((((map__2557.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2557.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2557):map__2557);
var file = cljs.core.get.call(null,map__2557__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__2557__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__2557__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__2556_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__2556_SHARP_));
...
var temp__5735__auto___2559 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___2559)){
var message_2560 = temp__5735__auto___2559;
cljs.core.println.call(null,message_2560);
} else {
}
...
var temp__5735__auto___2561 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___2561)){
var message_2562 = temp__5735__auto___2561;
cljs.core.println.call(null,message_2562);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__2563 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__2565 = exception.stack;
var G__2565__$1 = (((G__2565 == null))?null:clojure.string.split_lines.call(null,G__2565));
var G__2565__$2 = (((G__2565__$1 == null))?null:cljs.core.get.call(null,G__2565__$1,depth));
if((G__2565__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__2565__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__2566 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__2566,(0),null);
var column = cljs.core.nth.call(null,vec__2566,(1),null);
var vec__2569 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__2569,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__2569,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__2569,(2),null);
...
var m__$1 = (function (){var G__2572 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__2572__$1 = (((G__2572 instanceof cljs.core.Keyword))?G__2572.fqn:null);
switch (G__2572__$1) {
case "fail":
...
var G__2576 = (function (){var G__2575 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__2575);
} else {
return G__2575;
}
})();
...
return cljs.core.vary_meta.call(null,G__2577,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e2578){var e = e2578;
var G__2579 = e;
var G__2579__$1 = (((G__2579 instanceof cljs.core.Keyword))?G__2579.fqn:null);
switch (G__2579__$1) {
...
var vec__2581 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__2581,(0),null);
var types = vec__2581;
...
var ns = cljs.core.nth.call(null,vec__2585,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__2585,(1),null);
return (function (){
...
var G__2588 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__2588__$1 = (((G__2588 instanceof cljs.core.Keyword))?G__2588.fqn:null);
switch (G__2588__$1) {
case "async":
...
var seq__2589 = cljs.core.seq.call(null,vars__$1);
var chunk__2590 = null;
var count__2591 = (0);
var i__2592 = (0);
while(true){
if((i__2592 < count__2591)){
var v = cljs.core._nth.call(null,chunk__2590,i__2592);
var temp__5735__auto___2594 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___2594)){
var t_2595 = temp__5735__auto___2594;
each_fixture_fn.call(null,((function (seq__2589,chunk__2590,count__2591,i__2592,t_2595,temp__5735__auto___2594,v,each_fixture_fn,G__2588,G__2588__$1,env,once_fixtures,each_fixtures,vec__2585,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2595)));
});})(seq__2589,chunk__2590,count__2591,i__2592,t_2595,temp__5735__auto___2594,v,each_fixture_fn,G__2588,G__2588__$1,env,once_fixtures,each_fixtures,vec__2585,ns,vars__$1))
);
} else {
}


var G__2596 = seq__2589;
var G__2597 = chunk__2590;
var G__2598 = count__2591;
var G__2599 = (i__2592 + (1));
seq__2589 = G__2596;
chunk__2590 = G__2597;
count__2591 = G__2598;
i__2592 = G__2599;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__2589);
if(temp__5735__auto__){
var seq__2589__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2589__$1)){
var c__4609__auto__ = cljs.core.chunk_first.call(null,seq__2589__$1);
var G__2600 = cljs.core.chunk_rest.call(null,seq__2589__$1);
var G__2601 = c__4609__auto__;
var G__2602 = cljs.core.count.call(null,c__4609__auto__);
var G__2603 = (0);
seq__2589 = G__2600;
chunk__2590 = G__2601;
count__2591 = G__2602;
...
var v = cljs.core.first.call(null,seq__2589__$1);
var temp__5735__auto___2604__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___2604__$1)){
var t_2605 = temp__5735__auto___2604__$1;
each_fixture_fn.call(null,((function (seq__2589,chunk__2590,count__2591,i__2592,t_2605,temp__5735__auto___2604__$1,v,seq__2589__$1,temp__5735__auto__,each_fixture_fn,G__2588,G__2588__$1,env,once_fixtures,each_fixtures,vec__2585,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2605)));
});})(seq__2589,chunk__2590,count__2591,i__2592,t_2605,temp__5735__auto___2604__$1,v,seq__2589__$1,temp__5735__auto__,each_fixture_fn,G__2588,G__2588__$1,env,once_fixtures,each_fixtures,vec__2585,ns,vars__$1))
);
} else {
}


var G__2606 = cljs.core.next.call(null,seq__2589__$1);
var G__2607 = null;
var G__2608 = (0);
var G__2609 = (0);
seq__2589 = G__2606;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2588__$1)].join('')));
